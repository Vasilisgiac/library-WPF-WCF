...
namespace AllReservationsManage
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "Service1" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select Service1.svc or Service1.svc.cs at the Solution Explorer and start debugging.
    public class Service1 : IService1
    {
        public List<string> AllReservationsManage()
        {
            ...
            db.Open();
            string sql = @"select * from reservations order by submitdate";
            ...
            while (reader.Read() == true)
            {
                ...
                reservations.Add(reader["username"].ToString());
                reservations.Add(reader["firstname"].ToString());
                reservations.Add(reader["lastname"].ToString());
